# -*- coding: utf-8 -*-
#
# Owl Carousel documentation build configuration file, created by
# TYPO3 extension sphinx on Tue, 14 Apr 2015 16:50:11 +0200.
#
...
project = u'Owl Carousel'
copyright = u'2015, Raphael Zschorsch'
...
htmlhelp_basename = 'owlcarouseldoc'
...
latex_documents = [
    ('Index', 'owlcarousel.tex', u'Owl Carousel',
     u'Raphael Zschorsch', 'manual'),
]
...
pdf_documents = [
    ('Index', 'owlcarousel', u'Owl Carousel',
     u'Raphael Zschorsch'),
]
...
texinfo_documents = [
    ('Index', 'owlcarousel', u'Owl Carousel',
     u'Raphael Zschorsch', 'Owl Carousel', 'One line description of project.',
     'Miscellaneous'),
]
